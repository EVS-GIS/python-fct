...
class Parameters:
    ...
    continuity = DatasetParameter(
        'height raster (HAND)',
        type='input')

    def __init__(self, axis=None, variant='MAX'):
        """
...
def AggregateTile(
    ...
    raster1 = src1.continuity.tilename(row=row, col=col, **kwargs)
    raster2 = src2.continuity.tilename(row=row, col=col, **kwargs)
    output = out.continuity.tilename(row=row, col=col, **kwargs)
